  ...
  <div class="page active" id="page-dashboard">
    ...
    <div class="stats-grid" style="grid-template-columns:repeat(5,1fr);">
      ...
      <div id="inboundStatCard" onclick="toggleInboundPanel()" style="cursor:pointer;background:linear-gradient(160deg,#fff 50%,#dbeafe 100%);border:1px solid #e2e8f0;padding:16px 16px 0;display:flex;flex-direction:column;position:relative;overflow:hidden;transition:transform 0.2s,box-shadow 0.2s;box-shadow:0 1px 6px rgba(0,0,0,0.07);" onmouseover="this.style.transform='translateY(-4px) scale(1.02)';this.style.boxShadow='0 10px 28px rgba(0,0,0,0.13)'" onmouseout="this.style.transform='';this.style.boxShadow='0 1px 6px rgba(0,0,0,0.07)'">
        <div class="kpi-beam-2" style="position:absolute;top:0;left:-100%;width:45%;height:100%;background:linear-gradient(90deg,transparent,rgba(37,99,235,0.35),transparent);transform:skewX(-15deg);pointer-events:none;z-index:10;transition:left 1.2s ease;"></div>
    ...
    <div id="storingDetailPanel" style="display:none;margin-bottom:18px;">
      <div class="card" style="overflow:hidden;min-height:calc(100vh - 180px);display:flex;flex-direction:column;background:#eef1f5;">
    ...
    <div class="mid-grid">
      ...
      <div id="dailyActivityCard" style="background:linear-gradient(160deg,#fff 55%,#ede9fe 100%);border:1px solid #e2e8f0;overflow:hidden;position:relative;box-shadow:0 1px 6px rgba(0,0,0,0.07);transition:transform 0.2s,box-shadow 0.2s;" onmouseover="this.style.transform='translateY(-3px)';this.style.boxShadow='0 8px 20px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='';this.style.boxShadow='0 1px 6px rgba(0,0,0,0.07)'">
        ...
        <div id="dailyActivityChartWrap" style="padding:8px 12px 30px;height:370px;position:relative;overflow:visible;">
    ...
    <!-- TABEL LPPBDO -->
    <!-- LPPBDO grid — ikut mid-grid layout -->
    <div id="lppbdoGrid" style="display:grid;grid-template-columns:1fr 306px;gap:18px;margin-top:18px;align-items:start;">

      <!-- Tabel LPPBDO -->
      <div id="lppbdoSection" style="background:#fff;border:1px solid #e2e8f0;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,0.07);">
        ...
        <div style="overflow-x:auto;display:flex;flex-direction:column;">
          ...
          <div style="display:flex;align-items:center;justify-content:center;padding:10px;border-top:1px dashed #e2e8f0;background:#fff;">
      ...
      <!-- Chart LPPBDO -->
      <div style="background:#fff;border:1px solid #e2e8f0;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,0.07);display:flex;flex-direction:column;">
        <div style="height:3px;background:linear-gradient(90deg,#f97316,#7f1d1d,#94a3b8);flex-shrink:0;"></div>
        <div style="padding:14px 16px 10px;border-bottom:1px solid #f1f5f9;">
          <div style="display:flex;align-items:flex-start;justify-content:space-between;">
            <div>
              <div style="font-size:12px;font-weight:800;color:#1e293b;">Avg % per Kategori</div>
              <div style="font-size:9.5px;color:#94a3b8;">LPPBDO Bulan Ini</div>
            </div>
            <div id="lppbdoTotalAvg" style="text-align:right;">
              <div style="font-size:18px;font-weight:900;color:#dc2626;">—</div>
            </div>
          </div>
        </div>
        <div style="flex:1;padding:12px 16px;min-height:200px;">
          <div id="lppbdoChartWrap" style="height:220px;"></div>
        </div>
