...
function renderStoringPanel(data) {
  ...
  // Matikan efek hover (naik+scale) di seluruh panel Storing, KECUALI KPI cards
  if (!document.getElementById('storingNoHoverStyle')) {
    const st = document.createElement('style');
    st.id = 'storingNoHoverStyle';
    st.textContent = '#storingDetailPanel.card:hover, #storingDetailPanel .card:hover { transform:none !important; } #storingKpiRow > div { transition: transform 0.2s, box-shadow 0.2s; } #storingKpiRow > div:hover { transform: translateY(-3px); box-shadow: 0 6px 16px rgba(0,0,0,0.1); }';
